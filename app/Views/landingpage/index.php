...
<head>
    ...
    <link href="/Assets/startbootstrap/css/styles.css" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Lettchive</a>
    ...
    <!-- About-->
    <section class="page-section" id="about" style="background-color:#0275d8;">
        <div class="container px-4 px-lg-5" style="background-color:#0275d8;">
            <div class="row gx-4 gx-lg-5 justify-content-center" style="background-color:#0275d8;">
    ...
    <!-- Core theme JS-->
    <script src="/Assets/startbootstrap/js/scripts.js"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
